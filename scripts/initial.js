...
db.vault_categories.insertMany([
    ...
    },
    {
        name: 'advance',
        network: "ethereum",
        contract_address: '0x4f0bc6bd6beb231087781336bacd5613527ac63c',
        symbol: 'daoMPT',
        deposit: true,
        withdraw: true,
        depositMessage: '',
    ...
    },
    {
        name: 'expert',
        network: "ethereum",
        contract_address: '0xb2953c89615069fa6c14f3db3a09b7ecc077f533',
        symbol: 'daoMVF',
        deposit: true,
        withdraw: true,
        depositMessage: '',
    ...
    },
    {
        name: 'expert',
        network: "ethereum",
        contract_address: '0xc5719b5e85c30eb6a49d3c1b8058ae2435146c88',
        symbol: 'daoCDV2',
        deposit: true,
        withdraw: true,
        depositMessage: '',
    ...
    },
    {
        name: 'advance',
        network: "ethereum",
        contract_address: '0xb8e43526d2fee347f88e690ee86d047895472d04',
        symbol: 'daoSTO2',
        deposit: true,
        withdraw: true,
        depositMessage: '',
    ...
    },
    {
        name: 'advance',
        network: "avalanche",
        contract_address: '0x0b0e5b52e14152308f9f952ff19c67ebeb7560bb',
        symbol: 'daoAXA',
        deposit: true,
        withdraw: true,
        depositMessage: '',
    ...
    },
    {
        name: 'advance',
        network: "avalanche",
        contract_address: '0xdf9fc6774937bf42602be1f80ab3da8a0b2a8594',
        symbol: 'daoAXS',
        deposit: true,
        withdraw: true,
        depositMessage: '',
    ...
    },
    {
        name: 'advance',
        network: "avalanche",
        contract_address: '0x0d79f121fd1eb213e5dbde11edbe7744ecb51352',
        symbol: 'daoASA',
        deposit: true,
        withdraw: true,
        depositMessage: '',
    ...
    },
    {
        name: 'advance',
        network: "avalanche",
        contract_address: '	0x89d6fd8ba3eaf76687cf7b3d10f914cc445eaec1',
        symbol: 'daoA2S',
        deposit: true,
        withdraw: true,
        depositMessage: '',
    ...
    },
    {
        name: 'degen',
        network: "bsc",
        contract_address: '0x56f2005c3fec21dd3c21899fbceb1aae5b4bc5da',
        symbol: 'daoDEGEN',
        deposit: true,
        withdraw: true,
        depositMessage: '',
    ...
    },
    {
        name: 'basic',
        network: "bsc",
        contract_address: '0x81390703430015a751f967694d5ccb8745fda254',
        symbol: 'daoSAFU',
        deposit: true,
        withdraw: true,
        depositMessage: '',
...
db.strategies.insertMany([
    ...
    },
    {
        "name": "DAO Citadel",
        "symbol": "daoCDV",
        "vaultAddress": "0x626C25cA5b86277f395c0E40DBdF51f2a302aB43",
        "decimals": 18,
        "feeDecimals": 18,
        "address": "0xc9939B0b2af53E8BeCBA22ab153795e168140237",
        ...
        "info": "A balanced crypto portfolio enhanced with yield farming rewards.",
        "description": "A market weight strategy that gives an investor a balanced exposure to crypto. Portfolio components are paired up to earn yield farming rewards to boost returns.",
        "priceId": "daoCDV_price",
        "isPopularItem": true,
        "happyHourEnabled": true,
        "isDepositEnabled": true,
        "isWithdrawEnabled": true,
        ...
        "vaultInfo": {
            ...
            "abi": [
                ...
                "inputs": [{
                    ...
                    "name": "amtDeposit",
                    "type": "uint256"
                }, {"indexed": false, "internalType": "uint256", "name": "sharesMint", "type": "uint256"}],
                "name": "Deposit",
                "type": "event"
            }, {
                "anonymous": false,
                "inputs": [{"indexed": false, "internalType": "uint256", "name": "_balanceOfWETH", "type": "uint256"}],
                "name": "ETHToInvest",
                "type": "event"
            }, {
                "anonymous": false,
                ...
                "inputs": [{
                    ...
                    "name": "oldCustomNetworkFeePerc",
                    "type": "uint256"
                }, {"indexed": false, "internalType": "uint256", "name": "newCustomNetworkFeePerc", "type": "uint256"}],
                "name": "SetCustomNetworkFeePerc",
                "type": "event"
            }, {
                "anonymous": false,
                "inputs": [{
                    ...
                    "name": "oldCustomNetworkFeeTier",
                    "type": "uint256"
                }, {"indexed": true, "internalType": "uint256", "name": "newCustomNetworkFeeTier", "type": "uint256"}],
                "name": "SetCustomNetworkFeeTier",
                "type": "event"
            }, {
                "anonymous": false,
                "inputs": [{
                    ...
                    "name": "oldNetworkFeePerc",
                    "type": "uint256[]"
                }, {"indexed": false, "internalType": "uint256[]", "name": "newNetworkFeePerc", "type": "uint256[]"}],
                "name": "SetNetworkFeePerc",
                "type": "event"
            }, {
                "anonymous": false,
                "inputs": [{
                    ...
                    "name": "oldNetworkFeeTier2",
                    "type": "uint256[]"
                }, {"indexed": false, "internalType": "uint256[]", "name": "newNetworkFeeTier2", "type": "uint256[]"}],
                "name": "SetNetworkFeeTier2",
                "type": "event"
            }, {
                "anonymous": false,
                "inputs": [{
                    ...
                    "type": "uint256"
                }, {"indexed": true, "internalType": "uint256", "name": "newProfileSharingFeePerc", "type": "uint256"}],
                ...
                "inputs": [{
                    ...
                    "name": "amtWithdraw",
                    "type": "uint256"
                }, {"indexed": false, "internalType": "uint256", "name": "sharesBurn", "type": "uint256"}],
                "name": "Withdraw",
                "type": "event"
            }, {
                "inputs": [],
                ...
                "inputs": [{"internalType": "uint256", "name": "_tokenIndex", "type": "uint256"}],
                ...
                "inputs": [{"internalType": "address", "name": "_communityWallet", "type": "address"}],
                "name": "setCommunityWallet",
                "outputs": [],
                "stateMutability": "nonpayable",
                "type": "function"
                ...
                "inputs": [{"internalType": "uint256", "name": "_customNetworkFeeTier", "type": "uint256"}],
                "name": "setCustomNetworkFeeTier",
                "outputs": [],
                "stateMutability": "nonpayable",
                "type": "function"
            }, {
                "inputs": [{"internalType": "uint256[]", "name": "_networkFeePerc", "type": "uint256[]"}],
                "name": "setNetworkFeePerc",
                "outputs": [],
                "stateMutability": "nonpayable",
                "type": "function"
            }, {
                "inputs": [{"internalType": "uint256[]", "name": "_networkFeeTier2", "type": "uint256[]"}],
                "name": "setNetworkFeeTier2",
                "outputs": [],
                "stateMutability": "nonpayable",
                "type": "function"
            }, {
                "inputs": [{"internalType": "address", "name": "_pendingStrategy", "type": "address"}],
                "name": "setPendingStrategy",
                "outputs": [],
                "stateMutability": "nonpayable",
                "type": "function"
            }, {
                "inputs": [{"internalType": "uint256[]", "name": "_percentages", "type": "uint256[]"}],
                ...
                "inputs": [],
                "name": "strategy",
                "outputs": [{"internalType": "contract ICitadelStrategy", "name": "", "type": "address"}],
                "stateMutability": "view",
                "type": "function"
            }, {
                "inputs": [{
                    ...
                    "name": "_amount",
                    "type": "uint256"
                }], "name": "swapTokenWithinVault", "outputs": [], "stateMutability": "nonpayable", "type": "function"
            }, {
                "inputs": [],
                "name": "symbol",
                "outputs": [{"internalType": "string", "name": "", "type": "string"}],
                ...
                "stateMutability": "nonpayable",
                "type": "function"
            }, {"inputs": [], "name": "yield", "outputs": [], "stateMutability": "nonpayable", "type": "function"}]
        }
    }
])
